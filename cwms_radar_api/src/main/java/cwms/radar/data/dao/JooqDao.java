...
public abstract class JooqDao<T> extends Dao<T> {
    ...
    /**
     * Setup Jooq context getting the connection and office from the context.
     * @param ctx Javalin context
     * @return The DLSContext
     */
    ...
    /**
     * Setup Jooq context specifying a default Office.
     * @param database jdbc connection that is already open
     * @param officeId required office
