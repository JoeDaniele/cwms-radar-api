...
public interface TimeSeriesDao {
    ...
    TimeSeries getTimeseries(String cursor, int pageSize, String names, String office, String unit,
                             String datum, ZonedDateTime begin, ZonedDateTime end, ZoneId timezone);
    ...
    List<RecentValue> findMostRecentsInRange(List<String> tsIds,
                                             Timestamp pastLimit,
