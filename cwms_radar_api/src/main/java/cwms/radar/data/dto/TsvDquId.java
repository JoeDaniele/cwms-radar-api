...
public class TsvDquId implements java.io.Serializable {
    ...
    /**
     * Internal use only, id field for data retrieval queries.
     * @param officeId only office id
     * @param tsCode internal ts code (number) for a timeseries.
     * @param unitId units were pulling data as
     * @param dateTime date time of the data.
     */
