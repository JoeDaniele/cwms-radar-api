...
public class TsvDqu {
    ...
    /**
     * Timeseries value representation with units.
     * @param id internal id representation
     * @param cwmsTsId full CWMS Timeseries Name
     * @param versionDate timeseries version information
     * @param dataEntryDate date the data was stored
     * @param value actual value
     * @param qualityCode encoded quality information.
     * @param startDate internal field for table lookup
     * @param endDate internal field for table lookup
     */
