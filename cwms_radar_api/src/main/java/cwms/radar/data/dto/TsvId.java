...
public class TsvId implements java.io.Serializable {
     ...
     * @param tsCode internal Ts Code (number) to identify a timeseries
     * @param dateTime time of measurement/calculation
     * @param versionDate version of timeseries (e.g. date stored on a date to
     *     override but not erase existing data.)
     * @param dataEntryDate when the data was entered
     */
