...
public class VerticalDatumInfo {
    ...
    public static class Offset {
        ...
        /**
         * Offset from THIS datum to another.
         * @param isEstimate false if this is an official measurement.
         * @param toDatum Datum we're going to
         * @param value Difference to add to get to the target datum. (May be negative.)
         */
        ...
        public boolean equals(Object o) {
            ...
            if (getToDatum() != null
                            ? !getToDatum().equals(offset.getToDatum())
                            : offset.getToDatum() != null) {
                return false;
            }
            return getValue() != null
                              ? getValue().equals(offset.getValue())
    ...
    public static class Builder {
        ...
        public VerticalDatumInfo.Builder withOffset(boolean isEstimate,
                                                    String toDatum,
                                                    Double value) {
