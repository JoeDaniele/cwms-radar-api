...
public final class LocationLevel implements CwmsDTO {
    ...
    public static class Builder {
        ...
        /**
         * Create a new location level builder starting with the CWMS Location and a date/time.
         * @param name existing CWMS Location name.
         * @param effectiveDate Date/Time for which the value becomes
         *     a valid representation of this level.
         */
        @JsonCreator
        public Builder(@JsonProperty(value = "location-id") String name,
                       @JsonProperty(value = "level-date") ZonedDateTime effectiveDate) {
            locationId = name;
        ...
        /**
         * Start a new location level from an existing one.
         * @param copyFrom existing location level we wish to copy.
         */
        ...
        @SuppressWarnings("checkstyle:linelength") /// this isn't going to look better condensed.
        @JsonIgnore
        ...
        /**
         * Used to simply logic in the controller. Allows a loop to be used to go over properties.
        ...
        public Builder withProperty(String propertyName, Object value) {
            ...
            if (function == null) {
                throw new IllegalArgumentException(
                    "Property Name does not exist for Location Level");
            }
