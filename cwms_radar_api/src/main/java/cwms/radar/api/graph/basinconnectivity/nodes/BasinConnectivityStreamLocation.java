...
public class BasinConnectivityStreamLocation extends BasinConnectivityNode {
    ...
    /**
     * Create a StreamLoction element for the Basin Connectivity Graph.
     * @param streamLocation a stream location
     */
    public BasinConnectivityStreamLocation(StreamLocation streamLocation) {
        super(streamLocation.getStreamName(),
              streamLocation.getStation(),
