...
public class PeriodArguments implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        ...
        return Stream.of(
            Arguments.of(nowNormalDay,"PT-24H","UTC",
                         ZonedDateTime.of(2022,1,5,0,0,0,0,utc)),
            Arguments.of(nowNormalDay,"PT-25H-3M","UTC",
                         ZonedDateTime.of(2022,1,4,22,57,0,0,utc)),
            Arguments.of(nowDstBoundary,"PT-24H","US/Pacific",
                         ZonedDateTime.of(2022,3,12,23,0,0,0,pacific))
        );
    }
