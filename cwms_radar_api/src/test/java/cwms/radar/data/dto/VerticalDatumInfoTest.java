...
class VerticalDatumInfoTest {
    ...
    private void assertOffsetsEquals(VerticalDatumInfo.Offset[] offsets,
                                     VerticalDatumInfo.Offset[] offsets1) {
    ...
    private void assertOffsetEquals(VerticalDatumInfo.Offset expectedOffset,
    ...
    void testVertDatum1() throws VerticalDatumException, IOException {
        InputStream stream = getClass()
                                .getClassLoader()
                                .getResourceAsStream("cwms/radar/data/dto/vert1.xml");
    ...
    void testVertDatum2() throws VerticalDatumException, IOException {
        InputStream stream = getClass()
                                .getClassLoader()
                                .getResourceAsStream("cwms/radar/data/dto/vert2.xml");
        assertNotNull(stream);
        String v = readFully(stream);
    ...
    void testVertDatum3() throws VerticalDatumException, IOException, JAXBException {
        InputStream stream = getClass()
                                .getClassLoader()
                                .getResourceAsStream("cwms/radar/data/dto/vert3.xml");
        assertNotNull(stream);
        String v = readFully(stream);
